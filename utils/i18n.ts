...
export const getLocalizedScale = (scale: any, lang: Language): LocalizedContent => {
    ...
    // 3. Fallback to English for French, German, Spanish, Russian, Japanese, Chinese, Persian, Portuguese, UAE Arabic, and Hindi if i18n not found
    if ((lang === 'fr' || lang === 'de' || lang === 'es' || lang === 'ru' || lang === 'ja' || lang === 'zh' || lang === 'fa' || lang === 'pt' || lang === 'ae' || lang === 'hi') && scale.i18n && scale.i18n['en']) {
        return scale.i18n['en'];
    }
    if ((lang === 'fr' || lang === 'de' || lang === 'es' || lang === 'ru' || lang === 'ja' || lang === 'zh' || lang === 'fa' || lang === 'pt' || lang === 'ae' || lang === 'hi') && (scale.nameEn || scale.descriptionEn)) {
        return {
            name: scale.nameEn || scale.name,
            description: scale.descriptionEn || scale.description,
            tags: scale.tagsEn || scale.tags || []
...
export const getLocalizedProduct = (product: Product, lang: Language): LocalizedProductContent => {
    ...
    // 3. Fallback to English for French, German, Spanish, Russian, Japanese, Chinese, Persian, Portuguese, UAE Arabic, and Hindi if i18n not found
    if ((lang === 'fr' || lang === 'de' || lang === 'es' || lang === 'ru' || lang === 'ja' || lang === 'zh' || lang === 'fa' || lang === 'pt' || lang === 'ae' || lang === 'hi') && product.i18n && product.i18n['en']) {
        return product.i18n['en'];
    }
    if ((lang === 'fr' || lang === 'de' || lang === 'es' || lang === 'ru' || lang === 'ja' || lang === 'zh' || lang === 'fa' || lang === 'pt' || lang === 'ae' || lang === 'hi') && product.nameEn) {
        return {
            name: product.nameEn || product.name,
