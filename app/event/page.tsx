...
export default function EventPage() {
    ...
    const handleCouponDownload = () => {
        ...
        // 1. Open link in new tab (Primary action)
        window.open(currentCouponUrl, '_blank');

        // 2. Try to copy to clipboard silently (Best effort)
        navigator.clipboard.writeText(currentCouponUrl).catch(() => { });
    };
            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 items-stretch relative z-10 w-full">
                    ...
                    <div className="p-6 rounded-lg animate-pulse flex flex-col justify-center items-center h-full gap-2">
                        <h2 className="text-[40px] font-bold text-red-600 mb-0">선착순 4대 남음</h2>
                    </div>
