...
interface Digipan12_FsharpLowPygmyProps {
    scale?: Scale | null;
...
const Digipan12_FsharpLowPygmyBackground = ({ centerX = 500, centerY = 500, visualNotes = [], viewMode }: { centerX?: number; centerY?: number; visualNotes?: any[]; viewMode?: number }) => {
...
const Digipan12_FsharpLowPygmy = React.forwardRef<Digipan3DHandle, Digipan12_FsharpLowPygmyProps>(({
    scale,
    onScaleSelect,
    onNoteClick,
    ...
    return (
        <Digipan3D
            ...
            backgroundContent={<Digipan12_FsharpLowPygmyBackground visualNotes={visualNotes} viewMode={viewMode} />}
...
export default Digipan12_FsharpLowPygmy;
