...
interface Digipan18_EAmaraProps {
    scale?: Scale | null;
...
const Digipan18_EAmaraBackground = ({ centerX = 500, centerY = 500, visualNotes = [], viewMode }: { centerX?: number; centerY?: number; visualNotes?: any[]; viewMode?: number }) => {
...
const Digipan18_EAmara = React.forwardRef<Digipan3DHandle, Digipan18_EAmaraProps>(({
    scale,
    onScaleSelect,
    onNoteClick,
...
export default Digipan18_EAmara;
