...
interface Digipan12_FLowPygmyProps {
    scale?: Scale | null;
...
const Digipan12_FLowPygmyBackground = ({ centerX = 500, centerY = 500, visualNotes = [], viewMode }: { centerX?: number; centerY?: number; visualNotes?: any[]; viewMode?: number }) => {
...
const Digipan12_FLowPygmy = React.forwardRef<Digipan3DHandle, Digipan12_FLowPygmyProps>(({
    scale,
    onScaleSelect,
    onNoteClick,
    ...
    return (
        <Digipan3D
            ...
            backgroundContent={<Digipan12_FLowPygmyBackground visualNotes={visualNotes} viewMode={viewMode} />}
...
export default Digipan12_FLowPygmy;
