                                        ...
                                        {(() => {
                                            ...
                                            return purchaseUrl ? (
                                                <a
                                                    ...
                                                    href={purchaseUrl}
                                                    className="px-6 py-3 rounded-lg text-[20.8px] font-bold shadow-md transition-all flex items-center gap-1.5 bg-indigo-600 dark:bg-cosmic/50 hover:bg-indigo-700 dark:hover:bg-[#48FF00]/60 text-white hover:shadow-lg hover:-translate-y-0.5 whitespace-nowrap"
