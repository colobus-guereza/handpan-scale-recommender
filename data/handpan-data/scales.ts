...
export const SCALES: Scale[] = [
    ...
    // 32. C# Amara 9 (Restored)
    {
        ...
        vector: { minorMajor: -0.6, pureSpicy: 0.2, rarePopular: 0.8 },
        tags: ["마이너", "켈틱", "신비로움", "Amara"],
        description: "단조(Minor)의 슬픔보다는 신비롭고 몽환적인 켈틱(Celtic) 감성이 돋보이는 C# Amara 스케일입니다. 깊은 울림과 긴 여운이 특징으로, 감성적인 멜로디 연주나 배경 음악에 적합하며 초보자도 쉽게 아름다운 분위기를 연출할 수 있습니다.",
        descriptionEn: "The C# Amara scale stands out for its mystic and dreamy Celtic sensibility rather than the sadness of a typical minor key. Characterized by deep resonance and long sustain, it is suitable for emotional melody playing or background music, allowing even beginners to easily create a beautiful atmosphere.",
        ...
        ownUrlEn: "https://handpanen.imweb.me/21/?idx=103"
    },

    // 33. E Amara 18 (Restored)
    {
        ...
        vector: { minorMajor: -0.5, pureSpicy: 0.5, rarePopular: 0.9 },
        tags: ["Mutant", "Amara", "Extended", "Professional"],
        description: "E Amara (Celtic Minor) 스케일의 확장형 뮤턴트 모델로, 총 18개의 노트를 통해 광활한 음역대를 커버합니다. 풍부한 저음부터 섬세한 고음까지 아우르는 다채로운 표현력이 특징이며, 전문적인 연주와 작곡에 무한한 가능성을 열어주는 전문가용 악기입니다.",
    ...
    // 34. F# Low Pygmy 12 (Restored)
    {
        ...
        description: "F# Pygmy 스케일 특유의 몽환적이고 깊은 울림에 D3, E3 저음 노트가 더해져 더욱 풍성하고 입체적인 사운드를 만들어냅니다. 명상과 치유를 위한 연주에 최적화된 모델로, 마음을 차분하게 가라앉히는 신비로움을 선사합니다.",
        descriptionEn: "The F# Pygmy scale's characteristic dreamy and deep resonance is enhanced by the addition of low D3 and E3 notes, creating a richer and more three-dimensional sound. Optimized for meditation and healing performances, this model offers a mystique that calmly settles the mind.",
