...
export const SCALES: Scale[] = [
    ...
    // 30. F# Low Pygmy 12
    {
        ...
        description: "중앙아프리카 부족의 선율에서 유래한 피그미 스케일의 입문·중급자용 12노트 모델입니다. 기존 Pygmy 9, 10에서 아쉬웠던 베이스의 부재를 하판 2개 노트 추가로 완벽히 보완했습니다. 2도와 6도가 생략된 5음계 특유의 몽환적 울림과 두터운 저음이 어우러져, 유튜브에서 보던 '트렌디한 웰니스 감성'의 연주를 일반 악기에서도 풍성하게 구현할 수 있습니다.",
    ...
    // 31. E Amara 18
    {
        ...
        description: "일명 ‘Celtic Minor’로 불리는 아마라 스케일의 정점을 보여주는 18노트 ‘뮤턴트-전문가용’ 모델입니다. 고대 언어에서 ‘영원한’ 또는 ‘우아한’의 의미를 지닌 유래처럼, 화성 단조의 장엄함과 선법적 우아함이 공존하는 음계 특성이 특징입니다. 압도적인 음역폭을 통해 오케스트라적인 웅장함과 '트렌디한 웰니스 감성'을 동시에 구현합니다.",
        descriptionEn: "An 18-note 'Mutant-Professional' model representing the pinnacle of the Amara scale, also known as 'Celtic Minor'. Like its name, derived from ancient words meaning 'eternal' or 'graceful', it features scale characteristics where harmonic minor majesty and modal elegance coexist. With its overwhelming range, it simultaneously realizes orchestral grandeur and 'trendy wellness vibes'.",
