...
export const SCALES: Scale[] = [
    ...
    // 3. F# Hijaz 9 (The Exotic Tension)
    {
        id: "fs_hijaz_9",
        name: "F# Hijaz 9",
        notes: ["F#3", "C#4", "D4", "F4", "F#4", "G#4", "A4", "C5", "C#5"],
        vector: { minorMajor: -0.3, pureSpicy: 0.7, rarePopular: 0.6 },
        tags: ["이국적", "중동풍", "강렬함"],
        description: "사막의 신비로운 분위기를 자아냅니다. 높은 긴장감과 아름다운 해결이 특징입니다.",
        videoUrl: "",
        productUrl: ""
    },

    // 4. B Celtic / Amara (The Pentatonic Space)
    {
        id: "b_celtic_double",
        name: "B Celtic Minor",
        notes: ["B2", "F#3", "A3", "B3", "C#4", "D4", "E4", "F#4", "A4"],
        vector: { minorMajor: -0.6, pureSpicy: 0.05, rarePopular: 0.5 },
        tags: ["개방감", "몽환적", "명상적"],
        description: "열린 공간감과 몽환적인 분위기를 줍니다. 어떤 음을 연주해도 조화롭습니다.",
        videoUrl: "",
        productUrl: ""
    },
    ...
    // 5. E Equinox 14 (Mutant/Extended)
    {
        ...
        name: "E Equinox 14",
        notes: ["C3", "D3", "E3", "G3", "B3", "C4", "D4", "E4", "F#4", "G4", "B4", "C5", "D5", "E5"],
    ...
    // 6. F# Low Pygmy 14 (The Global Bestseller)
    {
        id: "fs_low_pygmy_14",
        name: "F# Low Pygmy 14",
        notes: ["D3", "E3", "F#3", "G#3", "A3", "C#4", "E4", "F#4", "G#4", "A4", "B4", "C#5", "E5", "F#5"],
    ...
    // 7. F Aeolian 10 (Domestic Steady Seller)
    {
        id: "f_aeolian_10",
        name: "F Aeolian 10",
        notes: ["F3", "Ab3", "Bb3", "C4", "Db4", "Eb4", "F4", "G4", "Ab4", "C5"],
        vector: { minorMajor: -0.8, pureSpicy: 0.15, rarePopular: 0.7 },
        tags: ["국내인기", "안정적", "우울함", "변신가능"],
    ...
    // 8. E Romanian Hijaz 10 (The Exotic Individualist)
    {
        ...
        notes: ["E3", "A3", "B3", "C4", "D#4", "E4", "F#4", "G4", "A4", "B4"],
    ...
    // 9. D Saladin 9 (The Extreme Niche)
    {
        id: "d_saladin_9",
        name: "D Saladin 9",
        notes: ["D3", "G3", "A3", "C4", "D4", "Eb4", "F#4", "G4", "A4"],
    ...
    // 11. E La Sirena 10 (The Siren / Dorian)
    {
        id: "e_la_sirena_10",
        name: "E La Sirena 10",
        notes: ["E3", "G3", "B3", "C#4", "D4", "E4", "F#4", "G4", "B4", "E5"],
    ...
    // 12. D Aegean 18 Mutant (The Global Big 3 / Lydian)
    {
        id: "d_aegean_18_mutant",
        name: "D Aegean 18 Mutant",
        notes: [
            "B2", "D3", "E3", "F#3", "G#3", "A3", "B3",
            "C#4", "D4", "E4", "F#4", "G#4", "A4", "B4",
            "C#5", "D5", "E5", "F#5"
        ],
        vector: { minorMajor: 0.9, pureSpicy: 0.25, rarePopular: 0.9 },
        tags: ["글로벌Big3", "리디안", "힐링", "Malte Marten Style"],
        description: "전 세계 3대장 스케일 중 하나입니다. 에게해의 푸른 바다처럼 희망차고 마법 같은 분위기를 선사하며, 힐링 연주에 최적화되어 있습니다.",
        videoUrl: "",
        productUrl: ""
    },

    // 13. E Amara 20 Mutant (The Global Big 3 / Celtic Minor)
    {
        id: "e_amara_20_mutant",
        name: "E Amara 20 Mutant",
        notes: [
            "C3", "D3", "E3", "F#3", "G3", "A3", "B3",
            "C4", "D4", "E4", "F#4", "G4", "A4", "B4",
            "C5", "D5", "E5", "F#5", "G5", "A5"
        ],
        vector: { minorMajor: -0.5, pureSpicy: 0.15, rarePopular: 0.95 },
        tags: ["글로벌Big3", "켈틱마이너", "힐링", "명상표준"],
        description: "전 세계 3대장 중 하나인 켈틱 마이너의 확장판입니다. 20개의 노트가 주는 웅장함과 안정감은 명상 음악의 표준이 되었습니다.",
        videoUrl: "",
        productUrl: ""
    },

    // 14. G Oxalis 9 (The Innocent Major / Pentatonic)
    {
        id: "g_oxalis_9",
        name: "G Oxalis 9",
        notes: ["G3", "B3", "C4", "D4", "E4", "G4", "B4", "C5", "D5"],
        vector: { minorMajor: 0.7, pureSpicy: 0.05, rarePopular: 0.6 },
        tags: ["메이저", "펜타토닉", "입문자추천", "순수함"],
        description: "가장 접근하기 쉬운 스케일 중 하나입니다. 순수하고 밝은 느낌으로, 아무렇게나 연주해도 듣기 좋은 소리가 납니다.",
        videoUrl: "",
        productUrl: ""
    },

    // 15. C# Pygmy 9 (The Original Trance Classic)
    {
        id: "cs_pygmy_9",
        name: "C# Pygmy 9",
        notes: ["C#3", "F#3", "G#3", "A3", "C#4", "E4", "F#4", "G#4", "A4"],
    ...
    // 16. C# Yisha Savita 9 (The Energetic Major / Annapurna)
    {
        id: "cs_yisha_savita_9",
        name: "C# Yisha Savita 9",
        notes: ["C#3", "G#3", "C4", "C#4", "D#4", "F4", "F#4", "G#4", "C#5"],
    ...
    // 17. F#2 Nordlys 15 (The Northern Lights / Lydian)
    {
        id: "fs2_nordlys_15",
        name: "F#2 Nordlys 15",
        notes: [
            "F#2", "A#2", "C#3", "F3",
            "F#3", "G#3", "A#3", "C4", "C#4", "F4", "G#4",
            "C5", "C#5", "F5", "G#5"
        ],
        vector: { minorMajor: 0.85, pureSpicy: 0.3, rarePopular: 0.6 },
        tags: ["리디안", "오로라", "저음", "우주적"],
        description: "'오로라'라는 이름처럼 우주적이고 신비로운 분위기를 자아냅니다. 깊은 저음과 리디안 모드의 조화가 환상적입니다.",
        videoUrl: "",
        productUrl: ""
    },

    // 18. C Harmonic Minor 13 (The Exotic/Spicy Minor)
    {
        id: "c_harmonic_minor_13",
        name: "C Harmonic Minor 13",
        notes: ["G3", "C4", "D4", "Eb4", "F4", "G4", "Ab4", "B4", "C5", "D5", "Eb5", "F5", "G5"],
        vector: { minorMajor: -0.4, pureSpicy: 0.75, rarePopular: 0.4 },
        tags: ["하모닉마이너", "이국적", "클래식", "매운맛"],
        description: "클래식하면서도 이국적인 매력을 지닌 스케일입니다. 독특한 음계 구조가 만들어내는 긴장감과 드라마틱한 전개가 특징입니다.",
        videoUrl: "",
        productUrl: ""
    },

    // 19. D Asha 15 (2-Octave Major)
    {
        id: "d_asha_15",
        name: "D Asha 15",
    ...
    // 20. E Equinox 12 (Normal, Bass 2 Dings)
    {
        id: "e_equinox_12",
        name: "E Equinox 12",
        notes: ["C3", "D3", "E3", "G3", "B3", "C4", "D4", "E4", "F#4", "G4", "B4", "C5"],
    ...
    // 21. E Equinox 10 (Normal)
    {
        id: "e_equinox_10",
        name: "E Equinox 10",
        notes: ["E3", "G3", "B3", "C4", "D4", "E4", "F#4", "G4", "B4", "C5"],
    ...
    // 22. F# Low Pygmy 18 (Mutant)
    {
        id: "fs_low_pygmy_18_mutant",
        name: "F# Low Pygmy 18 Mutant",
        notes: ["D3", "E3", "F#3", "G#3", "A3", "B3", "C#4", "D4", "E4", "F#4", "G#4", "A4", "B4", "C#5", "D5", "E5", "F#5", "G#5"],
    ...
    // 23. C# Pygmy 11 (Normal, Bass 2 Dings)
    {
        id: "cs_pygmy_11",
        name: "C# Pygmy 11",
        notes: ["D3", "E3", "C#3", "F#3", "G#3", "A3", "C#4", "E4", "F#4", "G#4", "A4"],
    ...
    // 24. F Low Pygmy 12 (Normal, Bass 2 Dings)
    {
        id: "f_low_pygmy_12",
        name: "F Low Pygmy 12",
        notes: ["Db3", "Eb3", "F3", "G3", "Ab3", "C4", "Eb4", "F4", "G4", "Ab4", "C5", "Eb5"],
    ...
    // 25. D Kurd 12 (Normal, Bass 2 Dings)
    {
        id: "d_kurd_12",
        name: "D Kurd 12",
        notes: ["E3", "F3", "D3", "A3", "Bb3", "C4", "D4", "E4", "F4", "G4", "A4", "C5"],
    ...
    // 26. F Low Pygmy 9 (Normal)
    {
        id: "f_low_pygmy_9",
        name: "F Low Pygmy 9",
        notes: ["F3", "G3", "G#3", "C4", "D#4", "F4", "G4", "G#4", "C5"],
    ...
    // 28. C Major 9
    {
        id: "c_major_9",
        name: "C Major 9",
        notes: ["C3", "G3", "A3", "B3", "C4", "D4", "E4", "F4", "G4", "A4"],
    ...
    // 29. C Rasavali 9
    {
        id: "c_rasavali_9",
        name: "C Rasavali 9",
        notes: ["C3", "G3", "Ab3", "C4", "D4", "E4", "F4", "G4", "Ab4", "C5"],
    ...
    // 30. C# Deepasia 14 (Normal)
    {
        id: "cs_deepasia_14",
        name: "C# Deepasia 14",
        notes: ["D#3", "F3", "C#3", "G#3", "A#3", "C#4", "D#4", "F4", "F4", "F#4", "G#4", "C#5", "D#5", "F5"],
    ...
    // 31. C# Blues 9 (Normal)
    {
        id: "cs_blues_9",
        name: "C# Blues 9",
        notes: ["C#3", "G#3", "B3", "C#4", "E4", "F#4", "G4", "G#4", "B4"],
    ...
    // 32. Eb MUJU 10 (Normal)
    {
        id: "eb_muju_10",
        name: "Eb MUJU 10",
        notes: ["Eb3", "G3", "Ab3", "Bb3", "C4", "Eb4", "F4", "G4", "Ab4", "C5"],
    ...
    // 34. C# Sapphire 9 (Normal)
    {
        id: "cs_sapphire_9",
        name: "C# Sapphire 9",
        notes: ["C#3", "G#3", "B3", "C#4", "F4", "F#4", "G#4", "B4", "C#5"],
    ...
    // 35. C# Annaziska 9 (Normal)
    {
        id: "cs_annaziska_9",
        name: "C# Annaziska 9",
        notes: ["C#3", "G#3", "A3", "B3", "C#4", "D#4", "E4", "F#4", "G#4"],
    ...
    // 36. E Hijaz 9 (Normal)
    {
        id: "e_hijaz_9",
        name: "E Hijaz 9",
        notes: ["E3", "A3", "B3", "C4", "D#4", "E4", "F#4", "G4", "B4"],
